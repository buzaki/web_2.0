        ...
        if($_GET['city']) {
          ...
          function weather($x)
          {
            ...
            $call = file_get_contents("http://api.openweathermap.org/data/2.5/weather?q=" . urlencode($x) . "&appid=" . $api_key ."&mode=json&units=metric");
              ...
              <div class="container">
                ...
                <form>
                  <fieldset class="form-group">
                    ...
                    "Eg. London, Tokyo" value = "<?php echo $_GET['city']; ?>">
                  </fieldset>
                ...
                if ($weather != "") {
                  ...
                  echo '<div class="alert alert-success" role="alert"><strong>City : </strong>'.$_GET['city'].' <small>'.$county.'</small><br />the Temperature is ' .$temp.'&degC<br />
                  humidity is '. $humidity .'% <br />Wind Speed is '.$wind_speed.' km/hr<br />'.$sky.'</div>';
